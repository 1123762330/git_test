package com.xn.shares_pointer_db.domain;
...
public class Shares implements Serializable {
    ...
    public Shares(Long id, String remHost, String username, String ourResult, String upstreamResult, String reason, String solution, Integer difficulty, String time, String height, String nonce, Integer workerId) {
        this.id = id;
        this.remHost = remHost;
        this.username = username;
        this.ourResult = ourResult;
