package com.xn.shares_pointer_db.service;
...
public class IRedisService<T> {
     ...
     * @return
     */
    public ZSetOperations<String,Object> getKeys() {
        return (ZSetOperations<String,Object>) hashOperations.keys(getRedisKey());
    }
