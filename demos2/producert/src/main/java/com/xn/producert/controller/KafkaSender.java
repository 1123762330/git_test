...
public class KafkaSender {
    ...
    public String send() throws Exception {
            PoolWorker worker = new PoolWorker(211,"atiet211",2853241594001576701L,"1112x30","cgminer/4.9.0","120.71.225.203","01003acf");
            ...
            //发送这个数据
            kafkaTemplate.send("lt", gson.toJson(data));
