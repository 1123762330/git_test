...
public class KafkaSender {
    ...
    public String send() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            String username = "AAABB";
            username += i;
            System.out.println(username);
            worker = new PoolWorker(202, username, 2853241594001576701L, "111X111", "cgminer/4.9.0", "120.71.225.203", "01003acf");
            ...
            //发送这个数据
            kafkaTemplate.send("day15", gson.toJson(data));
