...
public class StatsPoolHour implements Serializable {
    ...
    public StatsPoolHour() {
    }

    public StatsPoolHour(Integer hour, Long shareAccept, Long shareReject, Double rejectRate, BigDecimal score, BigDecimal earn, Date createdAt, Date updatedAt) {
        this.hour = hour;
        this.shareAccept = shareAccept;
        this.shareReject = shareReject;
        this.rejectRate = rejectRate;
