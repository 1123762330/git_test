...
public class StatsUsersDay implements Serializable {
    ...
    public StatsUsersDay() {
    }

    public StatsUsersDay(Integer puid, Integer day, Long shareAccept, Long shareReject, Double rejectRate, BigDecimal score, BigDecimal earn, Date createdAt, Date updatedAt) {
        this.puid = puid;
        this.day = day;
        this.shareAccept = shareAccept;
        this.shareReject = shareReject;
